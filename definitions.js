...
var createTeamForm = [{
  ...
  required: true,
  options: [{
    items: [{ label: "Scrum", value: "SCRUM" }, { label: "Kanban", value: "KANBAN" }]
  }]
}, {
  id: "SIZING_METRIC",
  type: "radiogroup",
  ...
  defaultValue: "POINTS",
  options: [{
    items: [{ label: "Points", value: "POINTS" }, { label: "Hours", value: "HOURS" }, { label: "Days", value: "DAYS" }]
  }]
}, {
  id: "VELOCITY_POINTS",
  type: "text",
...
var form1 = [{
  ...
  options: [{ items: ["apple", "banana", "kiwi", "melon", "grapefruit", "plum"] }]
}];
...
exports.createTeamForm = createTeamForm;
exports.form1 = form1;
exports.frag1 = frag1;
exports.frag2 = frag2;
exports.rendererChoice = rendererChoice;